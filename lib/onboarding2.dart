...
import 'package:commerce3/onboarding3.dart';
...
class _on2State extends State<on2> {
  ...
  //         context, MaterialPageRoute(builder: (_) =>  on3()));
  //   });
  // }
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20,),
              Image.asset('asset/img_8.png',height: 269,width: 269,),
              SizedBox(height: 15,),
              Image.asset('asset/img_9.png',width: 80,height: 8,),
              SizedBox(height: 30,),
              Text('Fast Delivery',textAlign:TextAlign.center,style: TextStyle(fontWeight:FontWeight.w500 ,fontSize:28 ,color: Color(0xff000000),),),
              SizedBox(height: 20,),
              Text(' Fast food delivery to your home',style: TextStyle(fontWeight:FontWeight.w500 ,fontSize:16 ,color: Color(0xffA6A6A6),),),
              Text(' office wherever you are',style: TextStyle(fontWeight:FontWeight.w500 ,fontSize:16 ,color: Color(0xffA6A6A6),),),
              SizedBox(height: 30,),
              Container(
                width:293 ,
                height: 48,
                child: ElevatedButton(
                  onPressed: (){
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const on3()),
                    );
                  },
                  style: ButtonStyle(
